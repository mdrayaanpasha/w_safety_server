...
export class UserController {
    ...
    static async verifyUser(req: Request, res: Response): Promise<Response> {
        try {
            ...
            const mailOptions = {
                ...
                subject: 'Welcome to Project Pukaar!',
                html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            .button {
                ...
                color: #ffffff !important; /* Text color is forced to be white */
    ...
    <body>
        <div class="container">
            <div class="header">
                <img src="https://raw.githubusercontent.com/mdrayaanpasha/women_safety_project/e7b0bffb121b6f8afe5470b70666e222b2d9d676/CLIENT/app/src/assets/logo.png" alt="Project Pukaar Logo">
            </div>
            <div class="content">
                <h1>Welcome, ${updatedUser.name}!</h1>
                <p>Your account has been successfully verified.</p>
                <p>Click the button below to get started and activate your account.</p>
